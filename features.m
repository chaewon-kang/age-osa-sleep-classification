...
%n_work=[9,22,32,33,87,113,120,123,124,141,146,147,148,149,150,155,157,158,159];
% 113 (each: 1000), 157 (no REM, short data),  132, 166

all_num=[35,45,55,65,83,104,106,108,110,112,126,137,151,154,163,26,53,105,...
				 ...
				 29, 90, 119, 140,164,165,167,168,54, 80,88,107,16,72,93,103,121,145,132,175,176,177,179,52,169,170,171,174];
...
for n_p = 1:163
    % reads edf and annotation files
